...
Write a partial that defines a variable `$color` and sets it to "#ff0000", and a stylesheet that imports the partial, and uses the variable to set the `color` style of the body element.
